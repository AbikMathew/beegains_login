import 'package:beegains_login_test/data/data_source/remote_data_source/enquiry_list_screen/equire_list_remote_data_source.dart';
...
class AuthAsyncNotifier extends AsyncNotifier<List<Enquiry>> {
  Future<List<Enquiry>> fetchEnquiryList() async {
    ...
    state = await AsyncValue.guard(() async {
      final enquireListRemoteDataSource = EnquireListRemoteDataSource();
